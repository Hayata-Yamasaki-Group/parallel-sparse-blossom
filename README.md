...
Files under `src/pymatching/` are derived from **PyMatching** and retain their original copyright and Apache-2.0 license headers. A copy of the PyMatching Apache-2.0 license is included as `LICENSE-PyMatching`.
