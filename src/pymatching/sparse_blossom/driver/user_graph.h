...
class UserGraph {
   public:
    ...
    const MatchingGraph& get_matching_graph_for_parallel_clustering();
    ProcessingClusterGraphCache* get_processing_cluster_graph_cache();
   ...
   private:
    ...
    std::unique_ptr<ProcessingClusterGraphCache> _processing_cluster_graph_cache;
};
